...
public interface UserRepository extends Neo4jRepository<Chat, String> {
	...
	@Query("CREATE(gc: GroupChat{name: $0, participants: $1, displayPictureArrayBuffer: $2, numberOfParticipants: $3})")
	...
	@Query("MATCH(c: User | GroupChat) WHERE (c.username = $0 OR c.name = $0) SET c.displayPictureArrayBuffer = $1")
